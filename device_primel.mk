...
PRODUCT_PACKAGES += highscreenpshelper
...
# BT A2DP
PRODUCT_COPY_FILES += \
    vendor/highscreen/primel/proprietary/vendor/lib/hw/audio.a2dp.blueangel.so:system/vendor/lib/hw/audio.a2dp.mt6735.so

# Audio components from source
PRODUCT_PACKAGES += \
    MtkCamera libDocVfbEngineLib_m81 libpanorama

#lib/highscreencamera
...
PRODUCT_EXTRA_RECOVERY_KEYS += device/highscreen/primel/highscreen

$(call inherit-product, $(SRC_TARGET_DIR)/product/core_64_bit.mk)
$(call inherit-product, $(SRC_TARGET_DIR)/product/full_base_telephony.mk)
#$(call inherit-product, build/target/product/aosp_arm64.mk)

#PRODUCT_NAME := cm_primel
#PRODUCT_DEVICE := primel
#PRODUCT_BRAND := CyaniogenMod
#PRODUCT_MODEL := CyaniogenMod on Highscreen Prime L
...
#persist.sys.highscreen.region=cn \
#persist.sys.highscreen.codepage=gbk \
#ro.highscreen.setupwizard.flyme=true \
#ro.highscreen.setupwizard.setlang=true \
#ro.highscreen.region.enable=true \
#ro.highscreen.contactmsg.auth=false \
#ro.highscreen.customize.pccw=false \
#ro.highscreen.autorecorder=true \
#ro.highscreen.visualvoicemail=true \
#ro.highscreen.security=false \
#ro.highscreen.permanentkey=false \
#ro.highscreen.sip.support=true \
#ro.highscreen.voip.support=false \
#sys.highscreen.m35x.white.config=false \
#sys.highscreen.white.config=false \
